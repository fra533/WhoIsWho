...
def dump_corpus():
    ...
    valid_pub = join(args.save_path, 'src', 'sna-valid', r'C:\Users\franc\OneDrive - Alma Mater Studiorum Università di Bologna\Desktop\BOND-OC\WhoIsWho\bond\dataset\data\src\sna-valid\mio_valid_pub.json')
